...
function PortfolioCard(
    ...
    return (
        <div className='portfolio-card flex p-5 gap-5 rounded-[32px] flex-col w-full  lg:w-[49%] border-[1px] border-solid border-[#72717133] glassmorphism'>
            ...
            <div className='flex flex-col gap-3'>
                <div className='flex justify-between'>
                    ...
                    <Link className="cat text-body-regular font-Satoshi-Regular btn hover:bg-primary-500 duration-700 text-gray-200 hover:text-white  border-[1px] border-solid border-[#72717133] rounded-[32px] py-2 px-3 w-max flex gap-2 cursor-pointer" href={link}>
                        {category}
